...
class SimpleXml
{
     ...
     * @param DOMNode $node
     * @param string $class_name 要返回的对象类名，该类必须是SimpleXMLElement或扩展自SimpleXMLElement
     ...
     * @param string $class_name string $class_name 要返回的对象类名，该类必须是SimpleXMLElement或扩展自SimpleXMLElement
